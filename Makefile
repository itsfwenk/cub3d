...
#    Updated: 2024/10/17 19:07:12 by mel-habi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UTILS_SRCS		= char_utils.c free_utils.c gc.c init_utils.c mlx_handlers.c mlx_utils.c movement_handlers.c print_utils.c
MAIN_SRCS		= cub3D.c
